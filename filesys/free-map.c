...
/* TA note: locks added here for concurrency control, as 
   now there can be multiple accesses to the free_map simultaneously */
...
free_map_open (void)
{
  struct file* free_map_file = file_open (inode_open (FREE_MAP_SECTOR));

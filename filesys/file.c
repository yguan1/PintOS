...
file_write_at (struct file *file, const void *buffer, off_t size,
               off_t file_ofs) 
{
  printf("entering file write in thread %d\n", thread_current()->tid);
  printf("checking file not null %d\n", file != NULL);
  return inode_write_at (file->inode, buffer, size, file_ofs);
  printf("finishing file write\n");
}
